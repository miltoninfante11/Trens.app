...
export function getPlanDetails(): PlanDetails {
  return {
    ...
    period: 'mensual',
    features: [
      'IA Entrenador HANK con +90 herramientas',
      'Cámara PRO 9:16 con editor integrado',
      'Grabación de videos ilimitada',
      'Bóveda personal de videos y fotos',
      'Constructor de rutinas con +500 ejercicios',
      'Plan nutricional con macros automáticos por IA',
      'Stack de suplementación con horarios y dosis',
      'Detección automática de récords personales',
      'Estimación de 1RM y análisis de progresión',
      'Sincronización musical con Spotify',
      'Feed social con likes, comentarios y saves',
      'Fotos de progreso con comparativas timeline',
      'Lista de compras generada desde tu plan',
      'Comandos de voz manos libres',
      'Análisis visual de técnica por IA',
      'Análisis nutricional con foto de comida',
      'Cardio blocks con tracking de intensidad',
      '4 deportes: GYM, Moto, Auto, Surf',
