...
import { Wrench, Link2, ShoppingBag, ChevronRight } from 'lucide-react-native';
...
const MODULES = [
  {
    href: '/(admin)/tienda',
    title: 'TIENDA',
    description: 'Productos, órdenes y catálogo',
    icon: ShoppingBag,
    color: '#DC2626',
  },
  {
    href: '/(admin)/enlaces',
    title: 'ENLACES',
    description: 'Short links y subdominios',
    icon: Link2,
    color: '#3B82F6',
  },
] as const;

export default function AdminHerramientasHub() {
  return (
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 100 }}>
        <View className="px-4 pt-4 pb-2">
          <View className="flex-row items-center gap-3 mb-2">
            ...
            <Text className="text-white text-xl font-bold tracking-wider">HERRAMIENTAS</Text>
          </View>
          <Text className="text-zinc-500 text-sm font-mono">
            Utilidades internas y herramientas operativas.
          </Text>
        </View>
